		...
		<div class="wrapper">
			...
			<div class="formwrapper">
				...
				<form action="" method="POST" name="registrationform">
					...
					<input type="text" id="username" placeholder="Username (Min 6 characters)" name="username" value="<?php if(isset($_POST['username'])){ print $_POST['username']; } ?>">
					<input type="password" id="password" placeholder="Password (Min 6 characters)" name="password" value="<?php if(isset($_POST['password'])){ print $_POST['password']; } ?>">
